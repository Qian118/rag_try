...
chat_tokenizer = AutoTokenizer.from_pretrained("/media/zhjk/zwb_dir/chatglm2/", trust_remote_code=True)
chat_model = AutoModel.from_pretrained("/media/zhjk/zwb_dir/chatglm2/", trust_remote_code=True,device_map="balanced_low_0").cuda()
...
def get_similar_query(query,num=3):
    ...
    for _ in range(0,num):
        ...
        response, _ = chat_model.chat(chat_tokenizer, query+"。改写上述话", history=[],do_sample=True,num_beams=3,temperature=0.8)
